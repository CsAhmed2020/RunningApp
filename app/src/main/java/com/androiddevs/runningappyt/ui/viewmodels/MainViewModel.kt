...
import com.androiddevs.runningappyt.common.SortType
...
class MainViewModel @ViewModelInject constructor(
     ...
     *  and we want to merge their emissions in one object: liveDataMerger. Then,
     *  liveData1 and liveData2 will become sources for the MediatorLiveData liveDataMerger and every time onChanged
